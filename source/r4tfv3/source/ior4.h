...
// R4 defines
// R4 ROMCTRL flags
#define IOR4_CTRL_BASE     MCCNT1_ENABLE | MCCNT1_RESET_OFF | MCCNT1_CMD_SCRAMBLE | MCCNT1_CLOCK_SCRAMBLER | MCCNT1_READ_DATA_DESCRAMBLE | MCCNT1_LATENCY2(24)
...
#define IOR4_CMD_FAT_ENTRY_SEND    (0xB4ull << 56)
#define IOR4_CMD_ROM_READ_REQUEST  (0xB6ull << 56)
#define IOR4_CMD_ROM_READ_DATA     (0xB7ull << 56)
#define IOR4_CMD_SD_READ_REQUEST   (0xB9ull << 56)
#define IOR4_CMD_SD_READ_DATA      (0xBAull << 56)
#define IOR4_CMD_SD_WRITE_START    (0xBBull << 56)
#define IOR4_CMD_SD_WRITE_STAT     (0xBCull << 56)
